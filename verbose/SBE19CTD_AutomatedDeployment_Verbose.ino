...
String line;
int sampleCounter = 0;
const int deployWaitInterval = 6000; //time to wait between deployments in ms.

//Output parameters, see https://drive.google.com/drive/u/0/folders/0B6GaVHv-A8dpc1VXQWkwTE10b3M
//Reference Hi/Lo 
double Refhi = 0;
double Reflo = 0;
char RefHEX[7];
